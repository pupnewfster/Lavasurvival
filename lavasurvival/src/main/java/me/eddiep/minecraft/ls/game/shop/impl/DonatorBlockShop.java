...
public class DonatorBlockShop extends Menu implements BlockShop {
    DonatorBlockShop(MenuManager manager, Inventory inv) {
        super(manager, inv);
    }
    ...
    @MenuItem(slot = 11, item = @ItemStackAnnotation(material = Material.ACACIA_FENCE, name = ""))
    public void buyAcaciaFence(MenuPlayer player) {
        if (canBuy(player))
            getUser(player).buyBlock(Material.ACACIA_FENCE, price(Material.ACACIA_FENCE));
    }

    @MenuItem(slot = 12, item = @ItemStackAnnotation(material = Material.FENCE_GATE, name = ""))
    public void buyFenceGate(MenuPlayer player) {
        if (canBuy(player))
            getUser(player).buyBlock(Material.FENCE_GATE, price(Material.FENCE_GATE));
    }

    @MenuItem(slot = 13, item = @ItemStackAnnotation(material = Material.SPRUCE_FENCE_GATE, name = ""))
    ...
    @MenuItem(slot = 14, item = @ItemStackAnnotation(material = Material.BIRCH_FENCE_GATE, name = ""))
    ...
    @MenuItem(slot = 15, item = @ItemStackAnnotation(material = Material.JUNGLE_FENCE_GATE, name = ""))
    ...
    @MenuItem(slot = 16, item = @ItemStackAnnotation(material = Material.DARK_OAK_FENCE_GATE, name = ""))
    ...
    @MenuItem(slot = 17, item = @ItemStackAnnotation(material = Material.ACACIA_FENCE_GATE, name = ""))
    ...
    @MenuItem(slot = 18, item = @ItemStackAnnotation(material = Material.SPRUCE_DOOR_ITEM, name = ""))
    ...
    @MenuItem(slot = 19, item = @ItemStackAnnotation(material = Material.BIRCH_DOOR_ITEM, name = ""))
    ...
    @MenuItem(slot = 20, item = @ItemStackAnnotation(material = Material.JUNGLE_DOOR_ITEM, name = ""))
    ...
    @MenuItem(slot = 21, item = @ItemStackAnnotation(material = Material.DARK_OAK_DOOR_ITEM, name = ""))
    ...
    @MenuItem(slot = 22, item = @ItemStackAnnotation(material = Material.ACACIA_DOOR_ITEM, name = ""))
