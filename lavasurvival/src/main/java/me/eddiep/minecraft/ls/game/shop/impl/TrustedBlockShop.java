...
public class TrustedBlockShop extends Menu implements BlockShop {
    ...
    @MenuItem(slot = 5, item = @ItemStackAnnotation(material = Material.BRICK_STAIRS, name = ""))
    public void buyBrickStairs(MenuPlayer player) {
        if (canBuy(player))
            getUser(player).buyBlock(Material.BRICK_STAIRS, price(Material.BRICK_STAIRS));
    }

    @MenuItem(slot = 6, item = @ItemStackAnnotation(material = Material.SMOOTH_STAIRS, name = ""))
    ...
    @MenuItem(slot = 7, item = @ItemStackAnnotation(material = Material.SANDSTONE_STAIRS, name = ""))
    ...
    @MenuItem(slot = 8, item = @ItemStackAnnotation(material = Material.RED_SANDSTONE_STAIRS, name = ""))
    ...
    @MenuItem(slot = 9, item = @ItemStackAnnotation(material = Material.SPRUCE_WOOD_STAIRS, name = ""))
    ...
    @MenuItem(slot = 10, item = @ItemStackAnnotation(material = Material.BIRCH_WOOD_STAIRS, name = ""))
    ...
    @MenuItem(slot = 11, item = @ItemStackAnnotation(material = Material.JUNGLE_WOOD_STAIRS, name = ""))
    ...
    @MenuItem(slot = 15, item = @ItemStackAnnotation(material = Material.COBBLE_WALL, name = ""))
    ...
    @MenuItem(slot = 16, item = @ItemStackAnnotation(material = Material.COBBLE_WALL, durability = 1, name = ""))
    ...
    @MenuItem(slot = 17, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, name = ""))
    ...
    @MenuItem(slot = 18, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 1, name = ""))
    ...
    @MenuItem(slot = 19, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 2, name = ""))
    ...
    @MenuItem(slot = 20, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 3, name = ""))
    ...
    @MenuItem(slot = 21, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 4, name = ""))
    ...
    @MenuItem(slot = 22, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 5, name = ""))
    ...
    @MenuItem(slot = 23, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 6, name = ""))
    ...
    @MenuItem(slot = 24, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 7, name = ""))
    ...
    @MenuItem(slot = 25, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 8, name = ""))
    ...
    @MenuItem(slot = 26, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 9, name = ""))
    ...
    @MenuItem(slot = 27, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 10, name = ""))
    ...
    @MenuItem(slot = 28, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 11, name = ""))
    ...
    @MenuItem(slot = 29, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 12, name = ""))
    ...
    @MenuItem(slot = 30, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 13, name = ""))
    ...
    @MenuItem(slot = 31, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 14, name = ""))
    ...
    @MenuItem(slot = 32, item = @ItemStackAnnotation(material = Material.STAINED_GLASS, durability = 15, name = ""))
    ...
    @MenuItem(slot = 33, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, name = ""))
    ...
    @MenuItem(slot = 34, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 1, name = ""))
    ...
    @MenuItem(slot = 35, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 2, name = ""))
    ...
    @MenuItem(slot = 36, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 3, name = ""))
    ...
    @MenuItem(slot = 37, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 4, name = ""))
    ...
    @MenuItem(slot = 38, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 5, name = ""))
    ...
    @MenuItem(slot = 39, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 6, name = ""))
    ...
    @MenuItem(slot = 40, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 7, name = ""))
    ...
    @MenuItem(slot = 41, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 8, name = ""))
    ...
    @MenuItem(slot = 42, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 9, name = ""))
    ...
    @MenuItem(slot = 43, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 10, name = ""))
    ...
    @MenuItem(slot = 44, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 11, name = ""))
    ...
    @MenuItem(slot = 45, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 12, name = ""))
    ...
    @MenuItem(slot = 46, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 13, name = ""))
    ...
    @MenuItem(slot = 47, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 14, name = ""))
    ...
    @MenuItem(slot = 48, item = @ItemStackAnnotation(material = Material.STAINED_GLASS_PANE, durability = 15, name = ""))
    ...
    @MenuItem(slot = 49, item = @ItemStackAnnotation(material = Material.PRISMARINE, name = ""))
    public void buyPrismarine(MenuPlayer player) {
        if (canBuy(player))
            getUser(player).buyBlock(Material.PRISMARINE, price(Material.PRISMARINE), (byte) 0);
    }

    @MenuItem(slot = 50, item = @ItemStackAnnotation(material = Material.PRISMARINE, durability = 1, name = ""))
    ...
    @MenuItem(slot = 51, item = @ItemStackAnnotation(material = Material.PRISMARINE, durability = 2, name = ""))
