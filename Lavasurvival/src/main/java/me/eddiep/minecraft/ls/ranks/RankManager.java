    ...
    public void setRanks() {
        if (!configFileRanks.exists())
            try {
                ...
                configRanks.set("Op.permissions", Arrays.asList("ls.setup", "ls.promote", "ls.demote", "ls.setrank",
                        "ls.voteSpeak", "ls.warn", "ls.hide", "ls.opchat", "ls.kick", "bukkit.command.gamemode",
                        "bukkit.command.teleport"));
                configRanks.set("Op.rankTitle", "&f[&6Op&f]");
                configRanks.set("Op.previousRank", "Elder");
                configRanks.set("Admin.permissions", Arrays.asList("ls.ban", "ls.endGame"));
