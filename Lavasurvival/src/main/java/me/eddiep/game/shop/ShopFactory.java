...
public class ShopFactory {
    ...
    public static Shop createShop(Plugin plugin, String ShopName, String bossShopName, Material material, List<String> description) {
        Shop shop = new Shop(bossShopName);
