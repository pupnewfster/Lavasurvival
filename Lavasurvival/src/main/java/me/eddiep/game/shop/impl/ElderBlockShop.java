...
public class ElderBlockShop extends Menu {
    Rank elder = Lavasurvival.INSTANCE.getRankManager().getRank("Elder");
    ...
    public void buyGlowstone(MenuPlayer player) {
        getUser(player).buyBlock(Material.GLOWSTONE, 580, elder);
    }
    ...
    public void buyNetherFence(MenuPlayer player) {
        getUser(player).buyBlock(Material.NETHER_FENCE, 720, elder);
    }
    ...
    public void buyNetherrack(MenuPlayer player) {
        getUser(player).buyBlock(Material.NETHERRACK, 720, elder);
    }
    ...
    public void buyNetherStairs(MenuPlayer player) {
        getUser(player).buyBlock(Material.NETHER_BRICK_STAIRS, 730, elder);
    }
    ...
    public void buyNetherBrick(MenuPlayer player) {
        getUser(player).buyBlock(Material.NETHER_BRICK, 900, elder);
    }
    ...
    public void buyNetherBrickSlab(MenuPlayer player) {
        getUser(player).buyBlock(Material.STEP, 900, (byte) 6, elder);
    }
    ...
    public void buyEndstone(MenuPlayer player) {
        getUser(player).buyBlock(Material.ENDER_STONE, 1100, elder);
    }
